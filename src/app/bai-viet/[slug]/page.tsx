      ...
      <main>
        <article className="article">
          ...
          <aside className="article-cta">
            ...
            <p>
              <a href="/tam-be">Tắm bé</a> 150.000đ/buổi (gói 10 buổi 1.200.000đ - gói 30 buổi
              3.000.000đ),{' '}
              <a href="/boi-thuy-lieu-cho-be">bơi thủy liệu (float)</a> 150.000đ,{' '}
              <a href="/thong-tac-tia-sua">thông tắc tia sữa</a> từ 350.000đ,{' '}
              <a href="/massage-bau">massage bầu</a> và{' '}
              <a href="/goi-lieu-trinh">gói liệu trình phục hồi sau sinh</a> từ 2.850.000đ - phục
              vụ tại spa &amp; tại nhà khu vực {site.khuVuc}. Spa xác nhận lịch trong 15 phút
              (8:00 - 17:30).
            </p>
